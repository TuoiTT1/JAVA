...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n========List three employees have best salary========");
		List<Employee> filterAndGroups = controller.filterThreeYoungersHaveBestSalary(emps, empsSortBySalaryDESC.get(0)
				.getSalary());
		...
		String s = "N";
		System.out.println("\n========List of employee contain character " + s + " in Name ========");
